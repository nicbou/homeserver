...
ORIGINAL_MOVIES_PATH = os.environ.get('ORIGINAL_MOVIES_PATH')
CONVERTED_MOVIES_PATH = os.environ.get('CONVERTED_MOVIES_PATH')
ORIGINAL_MOVIES_URL = os.environ.get('ORIGINAL_MOVIES_URL')
CONVERTED_MOVIES_URL = os.environ.get('CONVERTED_MOVIES_URL')
